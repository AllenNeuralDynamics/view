...
class QDockWidgetTitleBar(QFrame):
    ...
    def minimize(self):
        ...
        self._timeline = TimeLine(loopCount=1, interval=1, step_size=-2)
        self._timeline.timerEnded.connect(lambda: self.dock.setFixedHeight(25)) # prevent widget from resizing
